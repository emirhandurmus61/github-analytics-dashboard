  ...
  return (
    <div className="min-h-screen bg-zinc-950 overflow-hidden">
      ...
      <div className="relative">
        ...
        {/* Header bar */}
        <header className="relative z-10 border-b border-zinc-800/30 bg-zinc-950/40 backdrop-blur-2xl px-4 sm:px-6 py-3">
          <div className="mx-auto flex max-w-5xl items-center justify-between">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              >
                <svg className="h-3.5 w-3.5" fill={theme.accent} viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="flex items-center gap-1.5 rounded-lg border px-3 py-1.5 text-xs transition-all hover:scale-105 active:scale-95"
                style={{ borderColor: `${theme.accent}30`, backgroundColor: `${theme.accent}08`, color: theme.accent }}
              >
                <Download className="h-3 w-3" />
                <span className="hidden sm:inline">Karti Indir</span>
              </a>
              <a
